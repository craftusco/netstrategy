...
export async function getStaticProps() {
  ...
  const urls = [
    ...
    {
      name: "list_all",
      url: "https://www.netstrategy.it/api/project-details?populate=deep,3&pagination[limit]=-1&sort[0]=updatedAt%3Adesc",
    },
  ];
  ...
  return (
    <>
      ...
      <div>
        ...
        <ProjectsFilter categories={data.categorie} isGrid={handle} />
        </ProjectFIlterWrapper>
          ...
          <ProjectListGrid ref={listGrid} className="project-list-grid-ref">
            {sortedData.map((categoria, i) => (
              <React.Fragment key={i}>
                ...
                <div className="project-group" id={categoria.slug}>
                  ...
                  >
                    ...
                    >
                      {categoria.successi.map((succ, i) => (
                        <RedLink
                          link={getPath(`/successi/${succ.attributes.slug}`, true)}
                          img={getPath(
                          ...
                          >
                            <ImageContainer>
                              <Image
                                ...
                                //     .attributes.url
                                // )}
                                src={getPath(`${succ.attributes.thumbnail_success.immagine.data.attributes.formats.medium.url}`)}
                                alt={succ?.attributes?.thumbnail_success?.immagine?.data?.attributes?.alternativeText ? succ?.attributes?.thumbnail_success?.immagine?.data?.attributes?.alternativeText :
