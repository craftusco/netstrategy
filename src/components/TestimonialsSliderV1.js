...
export default function TestimonialsSliderV1({ data = null, mt }) {
                ...
                >
                  ...
                  {windowWidth < 500 ? (
                    <Desc
                      ...
                      isActive={(isActive && openDesc) || !isJavaScriptEnabled}
                      onTransitionEnd={(e) => {
                    ...
                    >
                      <PWrapper
                        ...
                        windowWidth={windowWidth}
                      >
                        <p className="review"> {slide.attributes.testo}</p>
                        <div className="author-info">
                          {slide.attributes.nome && (
                            <span>{slide.attributes.nome}</span>
                          )}
                            ...
                            <>
                              <RowRedLink
                                img={
                                  slide.attributes.successo_link.data != null &&
                                  getPath(
                                    slide.attributes.successo_link.data
                                      .attributes.thumbnail_success?.immagine
                                      .data.attributes.url
                                  )
                                }
                                link={slideLink}
                      ...
                      <CloseIcon isActive={isActive && openDesc}>
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          viewBox="0 0 25.243 25.242"
                        >
                          <g
                            id="Raggruppa_737"
                            data-name="Raggruppa 737"
                            transform="translate(-22.379 -4990.379)"
                          >
                            <line
                              id="Linea_385"
                              data-name="Linea 385"
                              x2="21"
                              y2="21"
                              transform="translate(24.5 4992.5)"
                              fill="none"
                              stroke="#fff"
                              strokeLinecap="round"
                              strokeWidth="3"
