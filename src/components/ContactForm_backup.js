          ...
          <>
            ...
            <div className="form-group">
              ...
              <div className="input-group">
                ...
                />
                {errors.website && (
                  <span className="val-error">{errors.website.message}</span>
                )}
              </div>
            </div>
            <div className="form-group">
                ...
                <>
                  {isWhite == true ? (
                    ...
                    <div className="input-group">
                      ...
                      >
                        <label className="dropdown-label">
                          <span>Tipologia di richiesta richiesta? *</span>
                          {/* <span>Seleziona il servizio *</span> */}
                        </label>
                        <DropDownInput
                          readOnly={true}
                          white={isWhite}
